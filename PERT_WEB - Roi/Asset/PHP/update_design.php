...
<?php
    if($_POST['update']){
        ...
        $query = "UPDATE form set fname='$fname',snumber='$snumber',gender='$gender',ylevel='$ylevel',dprogram='$dprogram',email='$email',phone='$phone',bdate='$bdate',address='$address' WHERE ID='$ID'";
