...
<br><br>
<a href="../PHP/adminhome.php">Back to Admin page</a>
</center>
...
<!-- echo $result['fname']." ".
        ...
        $result['address']."<br>"; -->
        <!-- &fn=$result[fname]
                &ln=$result[snumber] &gen=$result[gender] &yl=$result[ylevel]
                &dp=$result[dprogram] &em=$result[email] &ph=$result[phone]
                &bd=$result[bdate] &add=$result[address] -->